...
|-----|-------------|-------|-------|-------|-------|--------|
| 1   | 14.58 M/s   | 25 ns | 31 ns | 34 ns | 42 ns |  86 ns |
| 2   | 13.95 M/s   | 25 ns | 32 ns | 36 ns | 56 ns | 166 ns |
| 3   | 13.80 M/s   | 28 ns | 33 ns | 36 ns | 61 ns | 190 ns |
| 4   | 14.65 M/s   | 25 ns | 31 ns | 34 ns | 43 ns |  75 ns |
| 5   | 13.48 M/s   | 26 ns | 32 ns | 41 ns | 50 ns | 178 ns |
| **Avg** | **14.09 M/s** | **~26 ns** | **~32 ns** | **~36 ns** | **~50 ns** | **~139 ns** |
...
> line, P99.9 is expected to drop below 5 µs consistently.
...
│      │                                                          │
│      ▼  Lock-Free SPSC Input Queue  (524 K slots)               │
│                                                                 │
...
│      │                                                          │
│      ▼  Lock-Free SPSC Update Queue  (1 M slots)                │
│                                                                 │
...
the physical disk write asynchronously. This avoids the ~1–3 µs per-call overhead
...
Expected effect: max spike drops from ~12 µs → < 1 µs; P99.9 becomes
...
(which can exceed 100 µs on first access to a cold page) from the measured path.
